...
import { 
  ...
  CheckCircle, Clock, AlertCircle, ChevronRight, Loader
} from 'lucide-react';
...
const TicketCard = ({ ticket, formatDate, getStatusIcon, getStatusText, isPast }) => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `ticket_${ticket.ticket_number}.pdf`;
            ...
            {!isPast && (
              <div className="flex gap-2">
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 rounded-lg disabled:opacity-50"
                >
                  {downloading ? (
                    <>
